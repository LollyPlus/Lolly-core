...
namespace Lolly\Template\Wetpl;
...
class Parser{
    ...
    private function compile_import(){
        ...
        foreach($result as $file){
            ...
            if(is_file(Lolly . '/app/view/public/' . $file)){
                $this->temp = preg_replace($import_pattern, file_get_contents(Lolly . '/app/view/public/' . $file), $this->temp, 1);
            }else{
